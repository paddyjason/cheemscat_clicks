        ...
        <div className="fixed top-0 left-0 w-full px-4 pt-8 z-10 flex flex-col items-center text-white">
          <div className="w-full cursor-pointer">
            <div className="bg-[#1f1f1f] text-center py-2 rounded-xl">
              <p className="text-lg">JOIN THE CHEEMSCAT BELIVERS <Arrow size={18} className="ml-0 mb-1 inline-block" /></p>
            </div>
          </div>
        ...
        <div className="fixed bottom-0 left-0 w-full px-4 pb-4 z-10">
          <div className="w-full flex justify-between gap-2">
            ...
            <div className="flex-grow flex items-center max-w-60 text-sm">
              <div className="w-full bg-[#f8b9ce] py-4 rounded-2xl flex justify-around">
          ...
          <div className="w-full bg-[#f8b9ce] rounded-full mt-4">
            <div className="bg-gradient-to-r from-[#f8b9ce] to-[#fffad0] h-4 rounded-full" style={{ width: `${(energy / 6500) * 100}%` }}></div>
          </div>
        </div>
